...
/**
 * This handles the creation and binding of a new Worker. This creates the communication of
 * the ParcelScene running on the Worker with its corresponding ParcelScene on the Unity Build.
 */
export class UnityParcelSceneHandler extends UnityScene<LoadableParcelScene> {
